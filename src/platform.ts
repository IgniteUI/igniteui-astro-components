...
export type HeadTag =
  'title' | 'link' | 'style' | 'base' | 'meta' | 'script' | 'noscript' | 'template';
...
export type PlatformKey =
  'angular' | 'react' | 'blazor' | 'web-components' | 'slingshot' | 'appbuilder';
...
const IG_STYLES: HeadEntry[] = [
  ...
  // Note: @import layer() does not support the `integrity` SRI attribute.
  {
    tag: 'style',
    content:
      '@import url("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css") layer(bootstrap);',
  },
  {
    tag: 'link',
    attrs: { rel: 'stylesheet', href: 'https://www.infragistics.com/assets/modern/css/layout.css' },
  },
  {
    tag: 'link',
    attrs: {
      rel: 'stylesheet',
      href: 'https://www.infragistics.com/assets/modern/css/animate-custom.css',
    },
  },
  {
    tag: 'link',
    attrs: {
      rel: 'stylesheet',
      href: 'https://www.infragistics.com/assets/modern/css/fontello.css',
    },
  },
  {
    tag: 'link',
...
const IG_SCRIPTS: HeadEntry[] = [
  ...
  {
    tag: 'script',
    attrs: { src: 'https://www.infragistics.com/assets/modern/scripts/plugins.nav.js' },
  },
  {
    tag: 'script',
    attrs: { src: 'https://www.infragistics.com/assets/modern/scripts/navigation.js' },
  },
];
...
const APPBUILDER_STYLES: HeadEntry[] = [
  // Mega-menu plugin styles
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-content/uploads/maxmegamenu/style.css?ver=631e5d',
      media: 'all',
    },
  },
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-includes/css/dashicons.min.css',
      media: 'all',
    },
  },
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-content/plugins/megamenu-pro/icons/genericons/genericons/genericons.css',
      media: 'all',
    },
  },
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-content/plugins/megamenu-pro/icons/fontawesome6/css/all.min.css',
      media: 'all',
    },
  },
  // Bootstrap v4.4 partials — wrapped in a CSS cascade layer so they don't
  // override the docs theme. See custom.scss @layer declaration.
  {
    tag: 'style',
    content: [
  ...
  },
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/css/ig-modal.css',
      media: 'all',
    },
  },
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/css/styles.css',
      media: 'all',
    },
  },
  // Fonts
  {
    ...
    attrs: {
      rel: 'stylesheet',
      href: 'https://fonts.googleapis.com/css?family=Figtree:300,400,700&display=swap',
    },
  },
  {
    tag: 'link',
...
const APPBUILDER_SCRIPTS: HeadEntry[] = [
  ...
  {
    tag: 'script',
    attrs: { src: 'https://staging.appbuilder.dev/wp-includes/js/jquery/jquery.min.js?ver=3.7.1' },
  },
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-includes/js/jquery/jquery-migrate.min.js?ver=3.4.1',
    },
  },
  // Site JS
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/js/plugins.js?ver=1',
    },
  },
  {
    tag: 'script',
    attrs: { src: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/js/script.js?ver=1' },
  },
  // Mega-menu plugins
  {
    tag: 'script',
    attrs: { src: 'https://staging.appbuilder.dev/wp-includes/js/hoverIntent.min.js?ver=1.10.2' },
  },
  ...
  { tag: 'script', attrs: {}, content: 'var megamenu = {"timeout":"300","interval":"100"};' },
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-content/plugins/megamenu-pro/assets/public.js?ver=2.3.1.1',
    },
  },
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-content/plugins/megamenu/js/maxmegamenu.js?ver=3.3.1',
    },
  },
  // Contact form + lead tracking
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/js/sf.common.js?ver=1',
    },
  },
  {
    tag: 'script',
    attrs: {
      src: 'https://www.google.com/recaptcha/api.js?render=6Lc-MFAaAAAAAIWi7UOrSUfUZnVmDUSsXjzS4BgY&ver=1',
    },
  },
  {
    tag: 'script',
    attrs: {
      src: 'https://staging.appbuilder.dev/wp-content/themes/slingshot/js/leadTracker.js?ver=1',
    },
  },
];
